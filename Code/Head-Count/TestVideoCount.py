...
cap = cv.VideoCapture('Test/TestVideo.avi')
#camera = PiCamera()
...
##            print str(i.getX()), ',', str(i.getY())
    ...
    cv.putText(frame, str_count ,(10,90),font,0.5,(255,255,255),2,cv.LINE_AA)
    cv.putText(frame, str_count ,(10,90),font,0.5,(255,0,0),1,cv.LINE_AA)
